...
project = py2neo_package
copyright = py2neo_copyright
...
version = ".".join(py2neo_version.split(".")[0:2])
# The full version, including alpha/beta/rc tags.
release = py2neo_version
...
# of the sidebar.
html_logo = '../art/py2neo-glossy.190x260.png'
...
epub_title = py2neo_package
epub_author = py2neo_author
epub_publisher = py2neo_author
epub_copyright = py2neo_copyright
