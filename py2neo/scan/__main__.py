...
def scan(uri, auth=None):
    """ Scan...
    """
    from py2neo.scan import Scanner
    Scanner(uri, auth=auth).scan()


def main():
    parser = ArgumentParser(description=getdoc(scan))
    for a, kw in scan.arguments:
